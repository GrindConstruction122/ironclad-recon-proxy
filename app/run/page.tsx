            ...
            <div className="markdown-body" style={{ color: '#e2e8f0', fontSize: 15, lineHeight: 1.7 }}>
              <ReactMarkdown
                ...
                components={{
                  ...
                  code: ({ node, ...props }) => <code className="citation" style={{ background: 'rgba(14,165,233,0.12)', color: '#7dd3fc', padding: '1px 6px', borderRadius: 3, fontSize: '0.88em', fontFamily: 'Consolas, Monaco, monospace' }} {...props} />,
                  pre: ({ node, ...props }) => <pre style={{ background: 'rgba(8,12,18,0.6)', border: '1px solid rgba(14,165,233,0.15)', borderRadius: 4, padding: 14, overflowX: 'auto', marginTop: '0.6em', marginBottom: '0.8em', fontSize: 14, lineHeight: 1.5 }} {...props} />,
                  ...
                  th: ({ node, ...props }) => <th style={{ background: 'rgba(14,165,233,0.12)', border: '1px solid rgba(14,165,233,0.25)', padding: '8px 12px', textAlign: 'left', fontWeight: 800, color: '#f0f6ff' }} {...props} />,
                  td: ({ node, ...props }) => <td style={{ border: '1px solid rgba(14,165,233,0.15)', padding: '8px 12px', verticalAlign: 'top' }} {...props} />,
                  blockquote: ({ node, ...props }) => <blockquote style={{ borderLeft: '3px solid #0ea5e9', paddingLeft: 14, margin: '0.8em 0', color: '#cbd5e1', fontStyle: 'italic' }} {...props} />,
                  hr: ({ node, ...props }) => <hr style={{ border: 'none', borderTop: '1px solid rgba(14,165,233,0.2)', margin: '1.4em 0' }} {...props} />,
                  a: ({ node, ...props }) => <a style={{ color: '#38bdf8', textDecoration: 'underline' }} target="_blank" rel="noopener noreferrer" {...props} />,
                }}
              >
                {output}
              </ReactMarkdown>
